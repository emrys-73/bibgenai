...
<div class="container p-10 space-y-4 justify-center flex flex-col">
	...
	<p class="m-4">
        Describe a feeling, tell a story, or a problem you are facing and get a verse from the bible for it.
    </p>
    ...
    <div class="flex flex-col items-center">
        <p class="italic text-gray-500 text-xs justify-center bottom-4 w-[300px] md:w-[600px] lg:w-full text-center">
            Powered by <a href="https://astralta.com/">Astralta Technologies</a>
        </p>
    </div>
</div>
